...
@section('content')
    ...
    <div class="my-4">
        ...
        <p>هل لديك حساب بالفعل؟ <a href="{{route('showDonorLoginForm')}}"    style="color: #2fbac5; text-decoration: none">دخول</a></p>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <form class="container-form" action="{{route('donorRegister')}}" method="post">
                        @csrf
                        <div class="mb-3">

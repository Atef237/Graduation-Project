...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{__('all.roles_edit')}}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="card card-primary">
        ...
        <!-- form start -->
        <form method="post" action="{{route('roles.update',$row->id)}}" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{$row->translate('ar')?->title}}" name="title_ar"
                               id="title_ar"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{$row->translate('en')?->title}}" name="title_en"
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{$row->translate('ar')?->description}}" name="description_ar"
                               id="title_ar"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{$row->translate('en')?->description}}" name="description_en"
                               id="exampleInputEmail1"
                ...
                <div class="form-group">
                    ...
                    <select name="permissions[]" id="cars" multiple>
                        @foreach($permissions as $permission)
                            <option @if($permission->whereReation('roles','id',$row->id)) selected  @endif value="{{$permission->id}}">{{$permission->title}}</option>
                        @endforeach
                    </select>

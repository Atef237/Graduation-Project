            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{__('all.admins')}}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{__('all.all_admins')}}</h3>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($rows as $row)
                            <tr>
                                ...
                                <td>{{$row->name}}</td>
                                <td>{{$row->email}}</td>
                                <td>{{$row->is_active == '1' ? __('all.active') :  __('all.inactive')}}</td>

                                <td>
                                    @if(auth('admin')->user()->can('edit_admins'))
                                    ...
                                    @if(auth('admin')->user()->can('delete_admins'))
